...
public class Main {
    ...
    if(jwb.equals("Y") || jwb.equals("y")){ System.out.print("Berapa jumlah Buku Tulis? "); jwb = sc.nextLine(); n = Integer.parseInt(jwb);
    ...
    for (int i=1;i<=Integer.parseInt(jwb);i++){
        ...
        jwb = sc.nextLine();
        if(jwb.equals("Y") || jwb.equals("y")){ System.out.print("Berapa jumlah Pulpen? ");
            jwb = sc.nextLine();
        ...
        if(jwb.equals("Y") || jwb.equals("y")){
            ...
            jwb = sc.nextLine(); n = Integer.parseInt(jwb);
